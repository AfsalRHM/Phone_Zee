...
user_route.post('/addAddress', addressContoller.insertAddress);
user_route.post('/addToWishlist', wishlistController.addToWishlist);
user_route.post('/Wishlist', wishlistController.deleteProductFromWishlist);
user_route.post('/editAddress', addressContoller.updateAddress);
user_route.post('/profile', addressContoller.deleteAddress, orderController.deleteOrder);
user_route.post('/addToCart', cartController.addToCart);
user_route.post('/cart', cartController.deleteProductFromCart, cartController.updateCart);
